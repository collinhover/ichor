...
b2Math.b2CrossToOutFVV = function(s, a, out) {
		out.x = -s * a.y;
		out.y = s * a.x; 
};
...
b2Math.b2MulToOutRVV = function(R, v, out) {
		out.x = R.col1.x * v.x + R.col2.x * v.y;
		out.y = R.col1.y * v.x + R.col2.y * v.y; 
	};
b2Math.b2MulToOutMMM = function(A, B, out){
		out.col1.x = A.col1.x * B.col1.x + A.col2.x * B.col1.y;
		out.col1.y = A.col1.y * B.col1.x + A.col2.y * B.col1.y;
		out.col2.x = A.col1.x * B.col2.x + A.col2.x * B.col2.y;
		out.col2.y = A.col1.y * B.col2.x + A.col2.y * B.col2.y; 
	};

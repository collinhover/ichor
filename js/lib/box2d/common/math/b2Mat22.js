...
b2Mat22.prototype = 
{
	initialize: function(angle, c1, c2)
	{
		...
		if (c1 !== null && typeof c1 !== 'undefined' && c2 !== null && typeof c2 !== 'undefined'){
			this.col1.SetV(c1);
			this.col2.SetV(c2);
		}
		else{
	...
	Invert: function(out)
	{
		var a = this.col1.x, b = this.col2.x, c = this.col1.y, d = this.col2.y, det = a * d - b * c;
	...
	Solve: function(out, bX, bY)
	{
		...
		var a11 = this.col1.x, a12 = this.col2.x, a21 = this.col1.y, a22 = this.col2.y, det = a11 * a22 - a12 * a21;
		//b2Settings.b2Assert(det !== 0.0);
		det = 1.0 / det;

...
b2Shape.PolyMass = function(massData, vs, count, rho)
	{
		var center, area, I, pRef, inv3, p1, p2, p3, e1, e2, D, triangleArea, tVec, px, py, ex1, ey1, ex2, ey2, intx2, inty2, i;
		//b2Settings.b2Assert(count >= 3);

		//center = new b2Vec2(0.0, 0.0);
		center = new b2Vec2();
		center.SetZero();
...
b2Shape.PolyCentroid = function(vs, count, out)
	{
		var cX, cY, area, pRefX, pRefY, inv3, p1X, p1Y, p2X, p2Y, p3X, p3Y, e1X, e1Y, e2X, e2Y, D, triangleArea, i;
		//b2Settings.b2Assert(count >= 3);

...
//public:
	...
	*/
	...
	RemoveBufferedPair: function(proxyId1, proxyId2){
		...
		if (pair === null || typeof pair === "undefined")
		{
	...
	Commit: function(){
		var removeCount, proxies, pair, proxy1, proxy2, i;
...
//private:
	...
	AddPair: function(proxyId1, proxyId2){
		...
		//pairIndex = this.FindHash(proxyId1, proxyId2, hash);
	...
	RemovePair: function(proxyId1, proxyId2){
		var temp, hash, node, pNode, index, pair, userData;

...
Object.extend(b2DistanceJoint.prototype, 
{
	...
	PrepareVelocitySolver: function(step){
		var tMat, r1X, r1Y, r2X, r2Y, length, cr1u, cr2u, invMass, C, omega, d, k, PX, PY;
		...
		invMass = this.m_body1.m_invMass + this.m_body1.m_invI * cr1u * cr1u + this.m_body2.m_invMass + this.m_body2.m_invI * cr2u * cr2u;
		...
		if (this.m_frequencyHz > 0.0) {
			...
			//console.log("this.m_gamma: " + this.m_gamma + "  / this.m_bias: " + this.m_bias + " / this.m_mass: " + this.m_mass);
	...
	SolveVelocityConstraints: function(step){
		var tMat, r1X, r1Y, r2X, r2Y, v1X, v1Y, v2X, v2Y, Cdot, impulse, PX, PY;
	...
	SolvePositionConstraints: function(){
		var tMat, r1X, r1Y, r2X, r2Y, dX, dY, length, C, impulse, PX, PY;
	...
	GetReactionForce: function(invTimeStep)
	{
		...
		var F = new b2Vec2();
		F.x = this.m_impulse * this.m_u.x;
		F.y = this.m_impulse * this.m_u.y;
		return F;
	},

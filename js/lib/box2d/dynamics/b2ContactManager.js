...
Object.extend(b2ContactManager.prototype, 
{
	...
	PairAdded: function(proxyUserData1, proxyUserData2){
		var shape1, shape2, body1, body2, tempShape, tempBody, contact;
	...
	{
		var c = this.m_world.m_contactList, c0;
		while (c !== null)
		{
			c0 = c;
			c = c.m_next;
	...
	Collide: function()
	{
		var body1, body2, node1, node2, c, oldCount, newCount;
